...
<div class="flex items-center gap-4 text-text-main dark:text-white">
   <a href="/admin_classes"> <span class="material-symbols-outlined text-gray-400">arrow_back</span></a>
...
<h2 class="text-lg font-bold leading-tight tracking-tight">Classes Management</h2>
</div>
